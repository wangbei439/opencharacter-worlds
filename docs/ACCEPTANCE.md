...
|---|---|---|
| TypeScript + production build | `npm run build` | Pass; main script ~144 KB gzip; parser and save modules load on demand |
| Runtime/provider/save unit tests | `npm test` | 28 passed |

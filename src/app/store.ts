...
interface AppState {ready:boolean;route:'landing'|'wizard'|'play';wizardStep:number;selectedCharacterId?:string;activeChatId?:string;characters:Character[];chats:Chat[];messages:Message[];world?:WorldState;events:WorldEvent[];transactions:Transaction[];books:Worldbook[];personas:Persona[];provider:ProviderConfig;settings:Settings;sending:boolean;streamText:string;expression:Expression;context?:ContextReport;error?:{code:string;detail?:string};notice?:string;}
